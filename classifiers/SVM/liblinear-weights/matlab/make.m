...
try
	...
	if(strcmp(Type(1).Name, 'Octave') == 1)
		mex libsvmread.c
		mex libsvmwrite.c
		mex trainLSVMw.c linear_model_matlab.c ../linear.cpp ../tron.cpp ../blas/*.c
	...
	mex CFLAGS="\$CFLAGS -std=c99" -largeArrayDims libsvmread.c
		...
		mex CFLAGS="\$CFLAGS -std=c99" -largeArrayDims trainLSVMw.c linear_model_matlab.c ../linear.cpp ../tron.cpp "../blas/*.c"
