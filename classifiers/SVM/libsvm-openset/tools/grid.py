...
telnet_workers = []
#ssh_workers = ['calculon', 'calculon', 'calculon', 'calculon', 'calculon', 'calculon',\
ssh_workers = ['flexo', 'flexo', 'flexo', 'flexo', \
               'bender', 'bender', 'bender', 'bender',\
               'brannigan', 'brannigan', 'brannigan', 'brannigan',\
               'leela', 'leela', 'leela', 'leela' ]
#ssh_workers = ['flexo'] #'calculon', 'flexo' ]
nr_local_worker = 6
